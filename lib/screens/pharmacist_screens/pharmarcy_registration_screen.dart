...
class _PharmacyRegistrationScreenState extends State<PharmacyRegistrationScreen> {
  TextEditingController pharmacyNameTextEditingController = TextEditingController();
  TextEditingController pharmacyRegNumberTextEditingController = TextEditingController();
  TextEditingController pharmacyRegEmailTextEditingController = TextEditingController();
  TextEditingController pharmacyRegPhoneTextEditingController = TextEditingController();
  TextEditingController pharmacyAddressTextEditingController = TextEditingController();
